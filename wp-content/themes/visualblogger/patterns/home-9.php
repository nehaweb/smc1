...
<div class="wp-block-column" style="flex-basis:70%"><!-- wp:group {"style":{"border":{"radius":"4px"},"spacing":{"blockGap":"0","padding":{"top":"0px","right":"0px","bottom":"0px","left":"0px"}}},"className":"content-grid content-grid-2","layout":{"type":"constrained"}} -->
<div class="wp-block-group content-grid content-grid-2" style="border-radius:4px;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px"><!-- wp:query {"queryId":27,"query":{"perPage":"12","pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false},"displayLayout":{"type":"flex","columns":3}} -->
