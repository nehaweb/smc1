...
<div id="content" class="wp-block-group featured-content featured-content-2" style="margin-bottom:0.7rem"><!-- wp:columns {"style":{"spacing":{"blockGap":{"top":"0.7rem","left":"0.7rem"}}}} -->
...
<div class="wp-block-column" style="flex-basis:70%"><!-- wp:group {"style":{"spacing":{"padding":{"top":"20px","right":"20px","bottom":"20px","left":"20px"}},"border":{"radius":"4px"}},"backgroundColor":"background","className":"content-list content-list-2","layout":{"type":"constrained"}} -->
