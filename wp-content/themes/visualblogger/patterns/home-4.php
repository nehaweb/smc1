...
<div class="wp-block-columns"><!-- wp:column {"width":"70%"} -->
<div class="wp-block-column" style="flex-basis:70%"><!-- wp:group {"style":{"spacing":{"margin":{"bottom":"0.7rem"}}},"className":"featured-slider","layout":{"type":"constrained"}} -->
<div class="wp-block-group featured-slider" style="margin-bottom:0.7rem"><!-- wp:query {"queryId":22,"query":{"perPage":"3","pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"exclude","inherit":false},"displayLayout":{"type":"list","columns":3},"className":"owl-carousel owl-theme","layout":{"type":"default"}} -->
...
<div class="wp-block-column" style="flex-basis:30%"><!-- wp:query {"queryId":2,"query":{"perPage":"2","pages":0,"offset":"3","postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"exclude","inherit":false},"displayLayout":{"type":"list","columns":2},"className":"featured-small"} -->
...
<div class="wp-block-group" style="margin-top:0px"><!-- wp:group {"style":{"spacing":{"padding":{"top":"5px","right":"20px","bottom":"20px","left":"20px"}},"border":{"radius":"4px"}},"backgroundColor":"background","className":"content-list","layout":{"type":"constrained"}} -->
...
<div class="wp-block-group"><!-- wp:group {"style":{"spacing":{"padding":{"top":"20px","right":"20px","bottom":"20px","left":"20px"}},"border":{"radius":"4px"}},"backgroundColor":"background","layout":{"type":"constrained"},"fontSize":"normal"} -->
...
<h2 class="section-header has-normal-font-size"><strong>Follow Us</strong></h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->

<!-- wp:social-links {"openInNewTab":true,"showLabels":true,"size":"has-normal-icon-size","style":{"spacing":{"blockGap":{"top":"10px","left":"10px"},"margin":{"top":"1rem"}}},"className":"is-style-logos-only","layout":{"type":"flex","justifyContent":"space-between","orientation":"horizontal","flexWrap":"wrap"}} -->
